...
public class GetUserProfileListSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetUserProfileListSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetUserProfileListSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
