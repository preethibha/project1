...
public class GetUserProfileListByEmailSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetUserProfileListByEmailSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetUserProfileListByEmailSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
