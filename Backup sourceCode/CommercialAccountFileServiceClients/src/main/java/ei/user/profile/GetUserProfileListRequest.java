...
/**
 * <p>Java class for GetUserProfileListRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetUserProfileListRequest">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="UserProfileIdentifier" type="{http://ei/core/user_profile_identifier}UserProfileIdentifier" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "GetUserProfileListRequest", namespace = "http://ei/corporate/get_user_profile_list_request_crp31x1", propOrder = {
...
public class GetUserProfileListRequest {
    ...
    protected List<UserProfileIdentifier> userProfileIdentifier;
     ...
     * This is why there is not a <CODE>set</CODE> method for the userProfileIdentifier property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUserProfileIdentifier().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<UserProfileIdentifier> getUserProfileIdentifier() {
        if (userProfileIdentifier == null) {
            userProfileIdentifier = new ArrayList<UserProfileIdentifier>();
        }
