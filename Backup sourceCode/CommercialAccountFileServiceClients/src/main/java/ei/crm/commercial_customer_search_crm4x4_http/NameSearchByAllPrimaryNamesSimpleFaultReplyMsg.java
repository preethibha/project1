...
public class NameSearchByAllPrimaryNamesSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public NameSearchByAllPrimaryNamesSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public NameSearchByAllPrimaryNamesSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
