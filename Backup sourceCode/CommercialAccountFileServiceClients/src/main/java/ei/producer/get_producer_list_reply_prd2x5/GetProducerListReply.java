...
package ei.producer.get_producer_list_reply_prd2x5;
 ...
 *       &lt;sequence>
 *         &lt;element name="GetProducerListOutputs" type="{http://ei/producer/get_producer_list_outputs_prd2x5}GetProducerListOutputs" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GetProducerListReply", namespace = "http://ei/producer/get_producer_list_reply_prd2x5", propOrder = {
...
public class GetProducerListReply {
	...
	public String toString() {
		...
		List<GetProducerListOutputs> getProducerListOutputsList = this.getProducerListOutputs;
		sb.append("[ Producers List : ");
		for (GetProducerListOutputs getProducerListOutput : getProducerListOutputsList)
			{
				sb.append( getProducerListOutput.toString() );
			}
		sb.append("]");
