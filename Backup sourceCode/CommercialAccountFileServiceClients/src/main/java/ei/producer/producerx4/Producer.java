...
import ei.core.commission_rates_by_policy_category.CommissionRatesByPolicyCategory;
import ei.producer.producer_contact.ProducerContact;
import ei.producer.producer_enrollment_options.ProducerEnrollmentOptions;
import ei.producer.producer_group.ProducerGroup;
 ...
 *         &lt;element name="BusinessAddress" type="{http://ei/core/addressx3}Address" minOccurs="0"/>
 ...
 *         &lt;element name="ProducerIdentifier" type="{http://ei/producer/producer_identifierx1}ProducerIdentifier" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Producer", namespace = "http://ei/producer/producerx4", propOrder = {
    "mailingAddress",
    "producerRoleCode",
    "producerRoleName",
...
public class Producer {
    ...
    protected ProducerIdentifier producerIdentifier;
     ...
     *     
     */
    public ProducerIdentifier getProducerIdentifier() {
        return producerIdentifier;
    }

    /**
     * Sets the value of the producerIdentifier property.
     * 
     * @param value
     *     allowed object is
     *     {@link ProducerIdentifier }
     *     
     */
    public void setProducerIdentifier(ProducerIdentifier value) {
        this.producerIdentifier = value;
    }
	...
	public String toString() {
		return "[ ProducerRoleCode="
				+ this.getProducerRoleCode()
				+ ", ProducerRoleName="
				+ this.getProducerRoleName()
				+ ", ProducerRoleAbbreviation="
				+ this.getProducerRoleAbbreviation()
				+ ", ProcessingOfficeNumber="
				+ this.getProcessingOfficeNumber()
				+ ", ProducingBranchNumber="
				+ this.getProducingBranchNumber()
				+ ", ProducingBranchCode="
				+ this.getProducingBranchCode()
				+ ", ProducingBranchAbbreviation="
				+ this.getProducingBranchAbbreviation()
				+ ", NonAppointedProducerIndicator="
				+ this.isNonAppointedProducerIndicator()
				+ ", ProducerClassificationCode="
				+ this.getProducerClassificationCode()
				+ ", ProducerClassificationName="
				+ this.getProducerClassificationName()
				+ ", ProducerSpecialIdentificationCode="
				+ this.getProducerSpecialIdentificationCode()
				+ ", ProducerAppointmentDate="
				+ setDateFormat(this.getProducerAppointmentDate())
				+ ", ProducerOrganizationTypeCode="
				+ this.getProducerOrganizationTypeCode()
				+ ", ProducerTypeCode="
				+ this.getProducerTypeCode()
				+ ", CombineProducerGroupCode="
				+ this.getCombineProducerGroupCode()
				+ ", CommercialDirectBillIndicator="
				+ this.getCommercialDirectBillIndicator()
				+ ", PersonalDirectBillIndicator="
				+ this.getPersonalDirectBillIndicator()
				+ ", CommercialStatusCode="
				+ this.getCommercialStatusCode()
				+ ", CommercialCancellationDate="
				+ setDateFormat(this.getCommercialCancellationDate())
				+ ", PersonalCancellationDate="
				+ setDateFormat(this.getPersonalCancellationDate())
				+ ", MainProducerIndicator="
				+ this.getMainProducerIndicator()
				+ ", MasterProducerNumber="
				+ this.getMasterProducerNumber()
				+ ", SubMasterProducerNumber="
				+ this.getSubMasterProducerNumber()
				+ ", ProducerOrganizationTypeCode="
				+ this.getProducerOrganizationTypeCode()
