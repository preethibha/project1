...
public class GetFilteredProducerList2X5SimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetFilteredProducerList2X5SimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetFilteredProducerList2X5SimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
