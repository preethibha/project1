...
public class GetProducer2X5SimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetProducer2X5SimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetProducer2X5SimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
