 ...
 * generated in the ei.producer.extended_producerx3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ExtendedProducer_QNAME = new QName("http://ei/producer/extended_producerx3", "ExtendedProducer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ei.producer.extended_producerx3
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ei/producer/extended_producerx3", name = "ExtendedProducer")
