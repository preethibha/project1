...
public class ProducerIdentifier {
	...
	public String toString() {
		return "ProducerIdentifier [producerName=" + producerName
				+ ", producerNumber=" + producerNumber + ", producerSubNumber="
				+ producerSubNumber + ", naicNationalProducerNumber="
				+ naicNationalProducerNumber + ", producerId=" + producerId
				+ "]";
	}
