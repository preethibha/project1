 ...
 * generated in the ei.core.producer_identifierx2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProducerIdentifier_QNAME = new QName("http://ei/core/producer_identifierx2", "ProducerIdentifier");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ei.core.producer_identifierx2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ei/core/producer_identifierx2", name = "ProducerIdentifier")
