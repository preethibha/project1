...
public class GetProducerList2X6SimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetProducerList2X6SimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetProducerList2X6SimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
