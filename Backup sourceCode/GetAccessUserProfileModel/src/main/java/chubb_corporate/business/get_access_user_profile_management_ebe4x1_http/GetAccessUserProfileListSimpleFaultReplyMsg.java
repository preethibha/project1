...
public class GetAccessUserProfileListSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetAccessUserProfileListSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetAccessUserProfileListSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
