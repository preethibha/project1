...
public class UpdateGetAccessUserProfileSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public UpdateGetAccessUserProfileSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateGetAccessUserProfileSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
