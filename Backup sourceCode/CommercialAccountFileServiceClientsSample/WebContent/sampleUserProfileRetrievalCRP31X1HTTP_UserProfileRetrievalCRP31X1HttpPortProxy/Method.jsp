...
<LI><A HREF="Input.jsp?method=13&methodName=getUserProfile" TARGET="inputs">getUserProfile(com.test.crp31x1.GetUserProfileRequest)</A></LI>
<LI><A HREF="Input.jsp?method=90&methodName=getUserProfileList" TARGET="inputs">getUserProfileList(com.test.crp31x1.GetUserProfileListRequest)</A></LI>
<LI><A HREF="Input.jsp?method=123&methodName=getUserProfileListByEmail" TARGET="inputs">getUserProfileListByEmail(com.test.crp31x1.GetUserProfileListByEmailRequest)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleUserProfileRetrievalCRP31X1HTTP_UserProfileRetrievalCRP31X1HttpPortProxyid.getClass())) {
%>
