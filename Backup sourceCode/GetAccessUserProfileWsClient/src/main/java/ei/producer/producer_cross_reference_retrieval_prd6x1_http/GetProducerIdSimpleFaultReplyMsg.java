...
public class GetProducerIdSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetProducerIdSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetProducerIdSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
