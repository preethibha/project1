...
public class GetFilteredProducerCrossRefListSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetFilteredProducerCrossRefListSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetFilteredProducerCrossRefListSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
