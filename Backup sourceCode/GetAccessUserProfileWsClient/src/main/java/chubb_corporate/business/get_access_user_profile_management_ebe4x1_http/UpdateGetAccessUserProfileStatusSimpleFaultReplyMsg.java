...
public class UpdateGetAccessUserProfileStatusSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public UpdateGetAccessUserProfileStatusSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateGetAccessUserProfileStatusSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
