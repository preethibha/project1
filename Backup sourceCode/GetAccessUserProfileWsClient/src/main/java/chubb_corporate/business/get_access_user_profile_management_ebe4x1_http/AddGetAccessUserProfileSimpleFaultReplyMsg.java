...
public class AddGetAccessUserProfileSimpleFaultReplyMsg
    extends Exception
{
     ...
     * @param message
     */
    public AddGetAccessUserProfileSimpleFaultReplyMsg(String message, SimpleFault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public AddGetAccessUserProfileSimpleFaultReplyMsg(String message, SimpleFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
